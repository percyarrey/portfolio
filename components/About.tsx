      ...
      <div className="flex mt-10 gap-1">
        ...
        <div className="w-full md:ps-2 lg:ps-4">
          ...
          <div className="text-gray-700 text-justify text-md md:text-lg">
            I am a dedicated <b>Full-stack developer</b> based in Cameroon with
            over three years of experience in web and mobile application
            development.
            <span> </span>
            ...
            server-side logic. I thrive in collaborative environments and enjoy
            working on diverse projects that challenge my skills and creativity.
          </div>
          {/* WORKED */}
